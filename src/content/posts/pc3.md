...
前面推荐了大家通过官网去手动安装软件，这里有引出下一个问题了，有的人会找不到然后从不知道哪里的第三方下的安装包去安装结果捆绑了一堆垃圾软件，更有倒霉的直接中病毒。首先就是，搜索引擎的，问题有的人会习惯性用百度，其实是不太推荐的垃圾广告太多了，搜点问题用用没问题，下载软件就很容易出问题了，我个人常用的是必应，自带的edge浏览器自带的应该就是这个，chrom自带的是谷歌也可以设置里去换成这个。  
![](../assets/images/pc3-7.png)  
![](../assets/images/pc3-8.png)  
简单的以steam为例做个对比。  
以下是百度的搜索结果：
![](../assets/images/pc3-9.png)  
![](../assets/images/pc3-10.png)  
以下是必应搜索结果：
![](../assets/images/pc3-11.png)  
结果显而易见，当然必应也不是完全没有广告推广的，所以最好还是，保险起见一些软件还可以去小破站找相关的视频教程底下一般也会放有链接。  